...
import com.tempest.lokalassignment.presentation.screens.BookMarkPage
import com.tempest.lokalassignment.presentation.screens.HomePage
...
@Composable
fun HomeNavigation(navController: NavController, viewModal: JobViewModal) {
            ...
            NavigationBarItem(
                icon = {
                    Icon(
                        ...
                        tint = if (index == selectedItem) BottomBlue else Color.Unspecified
                    )
                },
